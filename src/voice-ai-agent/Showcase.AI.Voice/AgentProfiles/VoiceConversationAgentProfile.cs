...
public class VoiceConversationAgentProfile
{
    ...
    public List<ConversationState> ConversationStates { get; set; } = new();
    public const string DefaultAgentName = "VoiceConversationAgent";
