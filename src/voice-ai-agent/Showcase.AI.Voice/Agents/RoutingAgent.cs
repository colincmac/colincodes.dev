...
{
    public IList<AITool> Tools = new List<AITool>();
    public string Name = "RoutingAgent";
    public string Description = "Handles calls as a front desk admin by securely collecting and verifying personal information.";
